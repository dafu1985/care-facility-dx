...
export class InquiryMapper {
  static toCreateResponse(inquiry: Inquiry): CreateInquiryResponseDto {
    return {
  ...
  static toMessageResponse(message: InquiryMessage): InquiryMessageResponseDto {
    return {
  ...
  static toResponse(inquiry: Inquiry): InquiryResponseDto {
    return {
      inquiryId: inquiry.inquiryId,
  ...
  static toListItemResponse(inquiry: Inquiry): InquiryListItemResponseDto {
    return {
      inquiryId: inquiry.inquiryId,
  ...
  static toListResponse(inquiries: Inquiry[]): InquiryListItemResponseDto[] {
    return inquiries.map((inquiry) => this.toListItemResponse(inquiry));
  }
}
